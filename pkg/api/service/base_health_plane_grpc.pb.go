...
func (c *healthClient) Check(ctx context.Context, in *common.HealthCheckRequest, opts ...grpc.CallOption) (*common.HealthCheckResponse, error) {
	out := new(common.HealthCheckResponse)
	err := c.cc.Invoke(ctx, "/api.service.Health/Check", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *healthClient) Watch(ctx context.Context, in *common.HealthCheckRequest, opts ...grpc.CallOption) (Health_WatchClient, error) {
	stream, err := c.cc.NewStream(ctx, &Health_ServiceDesc.Streams[0], "/api.service.Health/Watch", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *healthWatchClient) Recv() (*common.HealthCheckResponse, error) {
	m := new(common.HealthCheckResponse)
...
func _Health_Check_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.service.Health/Check",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HealthServer).Check(ctx, req.(*common.HealthCheckRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Health_Watch_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(common.HealthCheckRequest)
...
func (x *healthWatchServer) Send(m *common.HealthCheckResponse) error {
